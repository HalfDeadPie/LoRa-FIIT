...
#define MAX_CONFIDENCE_BOUND 0x0A
#define LOWEST_SF 0x07 //number of lowest spreading factor used in LoRa@FIIT protocol

class UpperConfidenceBound: public Bandit
{
  public:
